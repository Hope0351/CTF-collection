...
- **Time:** 2–3 weeks.
- **Companion writeups:** [`The-Debarghya/TryHackMe-Writeups`](../20-events/archives/tryhackme/TryHackMe-Writeups), [`ShubhamJagtap2000/TryHackMe-THM`](../20-events/archives/tryhackme/TryHackMe-THM).
...
- **Companion repos:** [`docfate111/binary_exploitation`](../01-pwn/archives/binary_exploitation), [`merrychap/ctf-writeups`](../30-archetypes/archives/personal-collections/ctf-writeups-merrychap).
- **Time:** 6–8 weeks.
...
- **Companion repos:** [`orangetw/My-CTF-Web-Challenges`](../02-web/archives/My-CTF-Web-Challenges).
- **Time:** 4–6 weeks.
...
- **Curriculum:**
  ...
  3. Work through `1GN1tE/CTF_Writeups` — RE-focused.
- **Companion repos:** `Kasimir123/CTFWriteUps`, `1GN1tE/CTF_Writeups`.
- **Time:** 6–8 weeks.
...
- Team writeup archives: `p4-team/ctf`, [`r3kapig/writeup`](../30-archetypes/archives/team-archives/writeup-r3kapig), [`theori-io/ctf`](../30-archetypes/archives/team-archives/ctf-theori-io).
