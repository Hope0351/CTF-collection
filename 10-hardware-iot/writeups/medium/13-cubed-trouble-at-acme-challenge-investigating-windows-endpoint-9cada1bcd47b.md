# :electric_plug: [13 Cubed] Trouble at ACME Challenge - Investigating Windows Endpoints

---

# [13 Cubed] Trouble at ACME Challenge — Investigating Windows Endpoints

Hey Digital Forensics folks, this challenge is hardcoded like Ali Hadi’s cases, which this is one of the challenges in **13Cubed — Investigation Windows Endpoints **course, and the files are only shared with students. So, I can’t share the files here with you guys. A big thank for [Richard Davis](https://www.linkedin.com/in/davisrichardg/) allowing me to post my documentation process on Medium blog.
