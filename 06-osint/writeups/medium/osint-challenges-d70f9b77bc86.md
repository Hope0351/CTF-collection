...
> **Original Source:** [OSINT Challenges. Learning to find the Treasure Trove of…](https://infosecwriteups.com/osint-challenges-d70f9b77bc86)
...
*In my previous *[article](https://medium.com/bugbountywriteup/perform-reconnaissance-the-legal-way-osint-80c159b1402a)* I mentioned few OSINT tools that can be used for passive reconnaissance. In this article I’ll be attempting some HTB OSINT challenges. OSINT is also one of the key skills essential during the Reconnaissance phase of the Red Team assessment.*
...
*Originally published on [Medium](https://infosecwriteups.com/osint-challenges-d70f9b77bc86). All credit goes to the original author.*
