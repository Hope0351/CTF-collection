# :sleuth_or_spy: Payatu CTF 2025 Forensics, Infrastructure and OSINT Writeups

---

## OSINT

Most probably the most easy part of the challenges

One Blog to control them all (well mostly and the blog is not promoted -_-)

*This is how I found it (shoutout to google lens)*

Rest of the flags were to search the plane code and the types of wings related stuff.

If you are still searching skyscanner or google to find flights

Spoiler: You won’t.

Try exif the image convert the time to indian time and then search flights from Amsterdam to Milan as said in blog. You will find the flight.
Not uploading screenshot because the CTF ended and I slept without taking any flipping screenshots.
And also KL is the hint in the image.

*Found you*

B737 is your next answer.
Use the link in the challenge provided.

Just exif the image and the author is base64 encoded
Decode it and search the guy in social media

*Voila instagram account found*

Text him to get the flags.

He will respond you these
...
Just select all capital letters and rearrange them to find the bonus flag.
