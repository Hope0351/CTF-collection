# :link: Definitive Guide to SQL Injection
...
*[Source: Avast](https://www.avast.com/c-sql-injection#gref)*

SQL Injection is a vulnerability that occurs when an attacker can fetch information from the SQL Database. This is…
