# The Intended Solution for Lustrous

Solver: ustrous/tree/main/solver
...
On investigating for exploitable vulnerabilities, it is discovered that the `concat` built-in function has a vulnerability (ref: CVE-2024-22419).
...
This leads to the realization that an ABI decoding vulnerability can be exploited (ref: CVE-2024-26149).
