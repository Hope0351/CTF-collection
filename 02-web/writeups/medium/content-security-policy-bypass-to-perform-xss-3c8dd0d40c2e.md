# :globe_with_meridians: Content-Security-Policy Bypass to perform XSS using MIME sniffing

> **Original Source:** [Content-Security-Policy Bypass to perform XSS using MIME sniffing](https://infosecwriteups.com/content-security-policy-bypass-to-perform-xss-3c8dd0d40c2e)
...
So the full URL would be: [http://website.com/js/countdown.php?end=2534926825);alert(1);//](http://website.com/js/countdown.php?end=2534926825%29%3Balert%281%29%3B%2F%2F)
...
Our XSS payload will be based on what we found on the first XSS (<script>alert(1)</script>). Instead of executing a Javascript, we will load the URL of countdown.php which is [http://website.com/js/countdown.php?end=2534926825);alert(1);//](http://website.com/js/countdown.php?end=2534926825%29%3Balert%281%29%3B%2F%2F)
...
*Originally published on [Medium](https://infosecwriteups.com/content-security-policy-bypass-to-perform-xss-3c8dd0d40c2e). All credit goes to the original author.*
