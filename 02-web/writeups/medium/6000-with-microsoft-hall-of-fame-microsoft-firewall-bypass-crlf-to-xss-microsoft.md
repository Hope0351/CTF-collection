# :globe_with_meridians: $6000 with Microsoft Hall of Fame | Microsoft Firewall Bypass | CRLF to XSS | Microsoft Bug Bounty

> **Original Source:** [$6000 with Microsoft Hall of Fame | Microsoft Firewall Bypass | CRLF to XSS | Microsoft Bug Bounty](https://infosecwriteups.com/6000-with-microsoft-hall-of-fame-microsoft-firewall-bypass-crlf-to-xss-microsoft-bug-bounty-8f6615c47922)
...
Hello Hackers, Hope you are doing great. I am Neh Patel also known as [THECYBERNEH](https://www.linkedin.com/in/thecyberneh/), I am a Security Researcher from India. Today I am going to share the experience of getting my first 4-digit bounty from our favorite “#Microsoft” and the dream of every bug hunter “#Microsoft Hall of Fame” for P2 vulnerability[ Severity:Important]Bug:- CRLF to XSS and further exploitation ( You know what to do with it )
...
```
BeforeURL EncodingMain Payload:- 嘍嘊After URL Encoding嘍 :- %E5%98%8D嘊 :- %E5%98%8A
```
...
Structure of response I got:-Real Image:-
...
Structure of response I want:-Real Image:-
...
*Originally published on [Medium](https://infosecwriteups.com/6000-with-microsoft-hall-of-fame-microsoft-firewall-bypass-crlf-to-xss-microsoft-bug-bounty-8f6615c47922). All credit goes to the original author.*
