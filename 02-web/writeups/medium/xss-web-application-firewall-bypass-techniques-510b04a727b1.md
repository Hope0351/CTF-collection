# :globe_with_meridians: XSS Web Application Firewall Bypass Techniques

> **Original Source:** [XSS Web Application Firewall Bypass Techniques](https://infosecwriteups.com/xss-web-application-firewall-bypass-techniques-510b04a727b1)
...
Some security engineers might include more HTML tags or even event handlers. In cases like this, I recommend doing some extra research as there is a cheat sheet for this. The Portswigger has [amazing research](https://portswigger.net/web-security/cross-site-scripting/cheat-sheet) on this. There are a lot of, that could be used along with some event handlers that do not require interaction. You might want to copy all of those tags, pass it to the intruder, on the burp suite and check which ones are accepted or not.
...
*Originally published on [Medium](https://infosecwriteups.com/xss-web-application-firewall-bypass-techniques-510b04a727b1). All credit goes to the original author.*
