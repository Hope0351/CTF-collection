# :globe_with_meridians: BugBounty — Mastering the Basics (along with Resources)[Part-1]
...
Computer Fundamentals:Network Basics:
...
According to [Eric Steven Raymond](https://en.wikipedia.org/wiki/Eric_S._Raymond), “The single most important step any newbie can take toward acquiring hacker skills is to get a copy of Linux or one of the BSD-Unixes, install it on a personal machine, and run it. Trying to learn to hack on a Microsoft Windows machine or under any other closed-source system is like trying to learn to dance while wearing a body cast.“

Whichever OS you choose, ensure to familiarize yourself with essential commands through cheat sheets like this below:

Windows:Coding Proficiency: The Path to Mastery:
