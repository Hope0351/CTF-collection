...
> **Original Source:** [Register Mapping: From Blind Scan to Process Understanding in GRFICSv3](https://infosecwriteups.com/register-mapping-from-blind-scan-to-process-understanding-in-grficsv3-fec70743dd78)
...
In [Part 13a,](https://medium.com/@urjasec/part-20a-building-your-ot-security-lab-hands-on-manual-setup-ce87124bb891) we built the GRFICSv3 lab, a virtualized chemical plant running a real Tennessee Eastman process simulation, with a live PLC, HMI, and engineering workstation on an isolated OT network. We confirmed everything was reachable. We knew *where* data lived. We did not know *what any of it meant*.
...
If you need a refresher on FC1–FC4 and how Modbus address tables work, [Part 4](https://medium.com/@urjasec/industrial-protocols-modbus-and-dnp3-210eb4de5061) covers it. The GRFICSv3-specific detail worth knowing here: OpenPLC’s Modbus address mapping is *not* a flat offset. Three different IEC 61131–3 variable types map to different Modbus address ranges:
...
*Originally published on [Medium](https://infosecwriteups.com/register-mapping-from-blind-scan-to-process-understanding-in-grficsv3-fec70743dd78). All credit goes to the original author.*
