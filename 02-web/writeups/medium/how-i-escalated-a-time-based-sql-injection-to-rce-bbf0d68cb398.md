...
> **Original Source:** [How I Escalated A Time Based Sql Injection To Rce Bbf0D68Cb398](https://infosecwriteups.com/how-i-escalated-a-time-based-sql-injection-to-rce-bbf0d68cb398)
...
Since we know that we can stack queries, let’s find a way to execute OS commands here. Unlike MySQL, MSSQL offers a way to execute commands. I based on [this writeup](https://medium.com/@notsoshant/a-not-so-blind-rce-with-sql-injection-13838026331e) by
...
Unlike the [writeup above](https://medium.com/@notsoshant/a-not-so-blind-rce-with-sql-injection-13838026331e) that stores the command output in the database, I made a non-destructive way to read OS Command outputs.
...
*Originally published on [Medium](https://infosecwriteups.com/how-i-escalated-a-time-based-sql-injection-to-rce-bbf0d68cb398). All credit goes to the original author.*
