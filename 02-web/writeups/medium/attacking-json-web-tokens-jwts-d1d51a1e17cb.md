...
> **Original Source:** [Attacking JSON Web Tokens (JWTs). Forge the token to gain unauthorized…](https://infosecwriteups.com/attacking-json-web-tokens-jwts-d1d51a1e17cb)
...
*Originally published on [Medium](https://infosecwriteups.com/attacking-json-web-tokens-jwts-d1d51a1e17cb). All credit goes to the original author.*
