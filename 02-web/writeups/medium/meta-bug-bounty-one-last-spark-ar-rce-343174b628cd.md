...
> **Original Source:** [Meta bug bounty — One Last Spark AR RCE](https://infosecwriteups.com/meta-bug-bounty-one-last-spark-ar-rce-343174b628cd)
...
I highly recommend that you read [my previous Spark AR write up](https://medium.com/@fadyothman/metas-sparkar-rce-via-zip-path-traversal-b4df3f33dc41), while the two bugs are not related, the other post contains more information about how spark AR works and the methodology I follow to analyze Spark AR for vulnerabilities, with that said let’s begin.
...
*Originally published on [Medium](https://infosecwriteups.com/meta-bug-bounty-one-last-spark-ar-rce-343174b628cd). All credit goes to the original author.*
