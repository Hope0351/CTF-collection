# :globe_with_meridians: The Power of Open Source Intelligence | OSINT | CTF Newbies

> **Original Source:** [The Power of Open Source Intelligence | OSINT | CTF Newbies](https://infosecwriteups.com/the-power-of-open-source-intelligence-osint-ctf-newbies-b39db0421dd4)
...
[Hunter.io](http://Hunter.io):Hunter.io is a powerful email search tool that scours the web to find email addresses associated with a specific domain. It utilizes various sources, including public websites and social media platforms, to compile a list of email addresses related to your search query.
...
Whois Lookup: A query revealing domain registration details is useful for identifying domain owners. Tools like [Whois.net](http://Whois.net) and DomainTools simplify this process.
...
*Originally published on [Medium](https://infosecwriteups.com/the-power-of-open-source-intelligence-osint-ctf-newbies-b39db0421dd4). All credit goes to the original author.*
