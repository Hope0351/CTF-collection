...
> **Original Source:** [Attack Surface Monitoring using Open-Source Intelligence](https://infosecwriteups.com/attack-surface-monitoring-using-open-source-intelligence-90415e863e93)
...
In my previous publications (“[Unknown Attacks: Detect and Rate](https://medium.com/@makrushin/unknown-attacks-detect-and-rate-5ab5dff63dc)“, “[The Phenomena of Targeted Attacks](https://medium.com/@makrushin/the-phenomena-of-targeted-attacks-c71807a8b7f6)“), I described the key stages of the targeted attacks (so-called ‘kill-chain’). The first stage is called the ‘reconnaissance’ stage, which has to be carried out long in advance before the attacker will reach the first computer of the victim. The overall amount and the quality of the data collected on this stage define the level of success and, which is the most important the final cost of the attack.
...
*Originally published on [Medium](https://infosecwriteups.com/attack-surface-monitoring-using-open-source-intelligence-90415e863e93). All credit goes to the original author.*
