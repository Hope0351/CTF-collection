...
> **Original Source:** [EvilBox: One - PHP Web Shell RCE + Writable /etc/passwd to Root | OffSec PG Play](https://infosecwriteups.com/evilbox-one-php-web-shell-rce-writable-etc-passwd-to-root-offsec-pg-play-86677fd5984a)
...
*Originally published on [Medium](https://infosecwriteups.com/evilbox-one-php-web-shell-rce-writable-etc-passwd-to-root-offsec-pg-play-86677fd5984a). All credit goes to the original author.*
