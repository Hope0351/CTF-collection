# :globe_with_meridians: IW Weekly #3: SQL Injection, Data Exfiltration, Log Poisoning, Blind XSS, and more.
...
Hope you had a great week. Our team is excited to share that our Medium publication, [Infosec Writeups,](https://infosecwriteups.com/) has crossed 25,000 readers. Our [LinkedIn page](https://www.linkedin.com/company/infosec-writeups) too has more than 10,000 followers. If you have published an article on the publication, feel free to add yourself as a writer on your LinkedIn profile for some extra 🔥
...
- [Anugrah SR](https://twitter.com/cyph3r_asr) shared his transformational journey from being a Biologist to a Security consultant. [Watch it here](https://www.youtube.com/watch?v=Nn2PNouH-Z8).

- [Roshan Piyush](https://twitter.com/roshanpiyush) talked about Dissecting Techniques to Shoot API Arrows at Vulnerable Services. [Watch it here](https://youtu.be/1P0Ia3zar3s).

On that note, we’re planning IWCON version 2.0 super soon. And now, you can be a part of the awesome virtual cybersecurity event even before the world witnesses it! [Fill this form](https://docs.google.com/forms/d/11cRDhnD-6Q80sb_36Ybx7yQt6_zf467xTCT4mXTt0Ts/edit) to help us help “YOU” provide the best Infosec insights and learnings from amazing experts around the world.😊
