# :globe_with_meridians: Learn How Hackers hack Databases (PART 2)

> **Original Source:** [Learn How Hackers hack Databases (PART 2)](https://infosecwriteups.com/sql-injection-for-beginners-using-sqlmap-part-2-53e9775b67f5)
> **Platform:** infosecwriteups.com | **Category:** `WEB`

---

Hello friends, I’m Rajneesh Kumar Arya back again with my new blog on SQL Injection. If you haven’t checked out [my first blog](https://medium.com/@RajneeshKarya/sql-injection-for-beginners-using-sqlmap-36e091e8a070) so first take a look at that and then you can continue with this one so without further do let’s power on your system, get some coffee or tea and get jump into it.
...
So let’s hack one of the email from our list I choose ‘hariprakash0902@gmail.com’ as an email now we have to go to login page of this website.
...
*Originally published on [Medium](https://infosecwriteups.com/sql-injection-for-beginners-using-sqlmap-part-2-53e9775b67f5). All credit goes to the original author.*
