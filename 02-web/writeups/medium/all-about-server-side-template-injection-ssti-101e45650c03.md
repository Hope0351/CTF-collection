...
This can be easily exploited, as the name parameter in the URL is user-controllable. An arbitrary user can inject a malicious SSTI payload that can be [) 5 * 5}} and the result will be 25. This can be further escalated and may lead to remote code execution (RCE).
