...
1. It's really important to visualize the heap for this problem. Try **pwndbg** and **angelheap** (installation instructions in this [write-up](https://github.com/Sudoite/ctf-writeups)).
...
(Looks like `edit` does not take a `uid`.) Now I go into `gdb` with **pwndbg** and **angelheap** installed [see this write-up](https://github.com/Sudoite/ctf-writeups), and display the heap:
