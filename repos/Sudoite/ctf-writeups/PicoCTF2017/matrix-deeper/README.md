...
This is a 32-bit ELF binary. Running `string` on the file suggests that the application is quite similar to the original [matrix.c](https://github.com/Sudoite/ctf-writeups), so I started by reviewing the source code for that problem.
