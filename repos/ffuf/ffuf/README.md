...
- [Installation](https://github.com/ffuf/ffuf)
- [Example usage](https://github.com/ffuf/ffuf)
    - [Content discovery](https://github.com/ffuf/ffuf)
    - [Vhost discovery](https://github.com/ffuf/ffuf)
    - [Parameter fuzzing](https://github.com/ffuf/ffuf)
    - [POST data fuzzing](https://github.com/ffuf/ffuf)
    - [Using external mutator](https://github.com/ffuf/ffuf)
    - [Configuration files](https://github.com/ffuf/ffuf)
- [Help](https://github.com/ffuf/ffuf)
    - [Interactive mode](https://github.com/ffuf/ffuf)


## Installation

- [Download](https://github.com/ffuf/ffuf) a prebuilt binary from [releases page](https://github.com/ffuf/ffuf), unpack and run!
...
[here](https://github.com/ffuf/ffuf). 

A more detailed description about configuration file locations can be found in the wiki: 
[https://github.com/ffuf/ffuf/wiki/Configuration](https://github.com/ffuf/ffuf)
...
ffuf is released under MIT license. See [LICENSE](https://github.com/ffuf/ffuf).
