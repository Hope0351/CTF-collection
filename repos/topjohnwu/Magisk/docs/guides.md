...
- `update-binary`: Download the latest [module_installer.sh](https://github.com/topjohnwu/Magisk) and rename/copy that script as `update-binary`
...
- When your module is downloaded with the Magisk app, `update-binary` will be **forcefully** replaced with the latest [`module_installer.sh`](https://github.com/topjohnwu/Magisk). **DO NOT** try to add any custom logic in `update-binary`.
