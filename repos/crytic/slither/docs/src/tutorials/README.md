...
Besides detectors, Slither also offers code review capabilities through its [printers](https://github.com/crytic/slither) and [tools](https://github.com/crytic/slither).
