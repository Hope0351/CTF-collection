...
- [Top-level Command Output](https://github.com/crytic/slither): Standard top-level (for detectors, printers and tools)
- [Detectors output](https://github.com/crytic/slither)
- [Upgradeability output](https://github.com/crytic/slither)
