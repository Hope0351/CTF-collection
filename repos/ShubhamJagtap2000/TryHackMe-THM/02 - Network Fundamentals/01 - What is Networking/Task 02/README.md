...
Using our example from the [previous task](https://github.com/ShubhamJagtap2000/TryHackMe-THM), let's now imagine that Alice made some new friends named Zayn and Toby that she wants to introduce to Bob and Jim. 
