...
This is very similar with the [Backdoored Splunk](https://github.com/LazyTitan33/CTF-Writeups) challenge from last year. This time if we find something suspicious in the `dns-health.ps1` file:  
