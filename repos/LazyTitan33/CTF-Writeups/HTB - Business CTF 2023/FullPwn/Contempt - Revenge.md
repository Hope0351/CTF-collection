...
Because [Contempt](https://github.com/LazyTitan33/CTF-Writeups) had the unintended vulnerability with Zerologon, HTB created this challenge. I got both user AND root flags for this challenge via unintended means as well.
