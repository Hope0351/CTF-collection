...
Another way to get the flag, in a less dumb way, would be to patch the binary, just like I did in [Rock Paper Psychic](https://github.com/LazyTitan33/CTF-Writeups) where it is making the check for the special number:  
