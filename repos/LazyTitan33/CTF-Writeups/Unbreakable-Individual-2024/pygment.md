...
Note: I had to replace the lowercase ctf with upper case because the flag wasn't originally accepted. All in all this challenge felt lackluster with the most minimum of efforts from the creator. It boggles the mind why this was considered "medium". [sided-curl](https://github.com/LazyTitan33/CTF-Writeups) was much more difficult and interesting and with some thought actually put behind it.
