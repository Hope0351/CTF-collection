...
Projeyi güncel tuttukları ve [**`PR gönderdikleri için harika topluluk katkıda bulunanlara`**](https://github.com/projectdiscovery/nuclei) teşekkür ederiz. :heart:
...
<div align="center">
  ...
  <sub>**`nuclei`** [**MIT Lisansı**](https://github.com/projectdiscovery/nuclei) altında dağıtılmaktadır.</sub>
