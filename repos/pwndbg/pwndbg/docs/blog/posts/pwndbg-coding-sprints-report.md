...
* [reviewed and merged the fs/gs_base fetching improvement PR](https://github.com/pwndbg/pwndbg),
* [pinned the project's dependencies](https://github.com/pwndbg/pwndbg),
* [updated the unicorn dependency version](https://github.com/pwndbg/pwndbg),
* [added a "tip of the day" feature](https://github.com/pwndbg/pwndbg),
* [improved the UX of using Pwndbg within a Python virtual environment](https://github.com/pwndbg/pwndbg),
* and also [worked on enhancing the display of arguments when stopping on a call to the printf functions family](https://github.com/pwndbg/pwndbg).
...
* [Cleanup some code leftover after dropping Python 2 support](https://github.com/pwndbg/pwndbg),
* [Added documentation on how to debug Pwndbg using PyCharm remote debugging](https://github.com/pwndbg/pwndbg),
* Reviewed and merged the PRs that [sets `$base_heap` variable](https://github.com/pwndbg/pwndbg) and [a tip for it](https://github.com/pwndbg/pwndbg), which may be useful for heap exploitation,
* [Fix the X30 register display on AARCH64 targets](https://github.com/pwndbg/pwndbg),
* [Fix `context args` display when PC/IP register pointed to unmapped memory](https://github.com/pwndbg/pwndbg),
* [Fixed the `xor` and `memfrob` commands and added tests for them (! :D)](https://github.com/pwndbg/pwndbg),
* [Worked on adding a way to dump memory that can be copied right away as C or Python code](https://github.com/pwndbg/pwndbg) (this needs to be changed to a command flag),
* Investigated a [potential parsing issue](https://github.com/pwndbg/pwndbg), even looking at GDB's command parsing source code, [implemented potential patch](https://github.com/pwndbg/pwndbg), which only later turned out to be redundant and the issue to be invalid.
