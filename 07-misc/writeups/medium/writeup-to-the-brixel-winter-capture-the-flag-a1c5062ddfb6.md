# :game_die: Writeup to the Brixel winter capture the flag
...
*The distribution of raw score in Brixel winter CTF (2020 ed.). The vertical line is my place in the contest (check out the scoreboard [here](https://archive.is/hXOk1), my results [here](https://archive.is/nS1xl) and the code used to generate this graph [here](https://github.com/Alekseyyy/ctfs/tree/main/infosec/2020/brixelctf/statistics)).*
