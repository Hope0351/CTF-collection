...
We are going to use a tool called [aquatone](https://github.com/michenriksen/aquatone/releases/) to find out which domains we are able to access. Refer this article to install the tool.
