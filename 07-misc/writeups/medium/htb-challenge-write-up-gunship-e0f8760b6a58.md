...
> **Original Source:** [HTB Challenge Write-Up: Gunship. Code Review](https://infosecwriteups.com/htb-challenge-write-up-gunship-e0f8760b6a58)
...
After searching for *"pug AST RCE"*, I discovered a Medium [article](https://rayepeng.medium.com/how-ast-injection-and-prototype-pollution-ignite-threats-abb165164a68) discussing *AST injection*. It details how Pug is vulnerable to RCE through AST injection. Now let’s test this payload:
...
*Originally published on [Medium](https://infosecwriteups.com/htb-challenge-write-up-gunship-e0f8760b6a58). All credit goes to the original author.*
