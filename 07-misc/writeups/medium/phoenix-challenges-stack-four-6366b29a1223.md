...
> **Original Source:** [Phoenix Challenges - Stack Four. The Challenge](https://infosecwriteups.com/phoenix-challenges-stack-four-6366b29a1223)
...
Next step: finding the complete_level() function’s address. As explained in the [Stack Three writeup](https://medium.com/bugbountywriteup/phoenix-challenges-stack-three-984e0434356b), it can be found both with objectdump or Pwndbg. We’ll practice using Pwndbg as we’ll be using it extensively
...
*Originally published on [Medium](https://infosecwriteups.com/phoenix-challenges-stack-four-6366b29a1223). All credit goes to the original author.*
