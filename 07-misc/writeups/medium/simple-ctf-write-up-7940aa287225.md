...
> **Original Source:** [Simple CTF (Write-up). Introduction](https://infosecwriteups.com/simple-ctf-write-up-7940aa287225)
...
Here we notice that we can run `vim` with root access with some googling, i find this [blog](https://medium.com/schkn/linux-privilege-escalation-using-text-editors-and-files-part-1-a8373396708d) that explains how to run system commands using `vim` (-c flag)
...
*Originally published on [Medium](https://infosecwriteups.com/simple-ctf-write-up-7940aa287225). All credit goes to the original author.*
