...
> **Original Source:** [Medium](https://infosecwriteups.com/bypassing-waf-to-do-error-based-sql-injection-dd52773a66d3)
...
The selected text in the image leads to an interesting point: [http://domain.com/REDACTED/news.php?id=13](http://domain.com/REDACTED/news.php?id=13)
...
*MySQL error when visiting the endpoint*
...
*2 errors when trying to find the 6th column*
...
*Originally published on [Medium](https://infosecwriteups.com/bypassing-waf-to-do-error-based-sql-injection-dd52773a66d3). All credit goes to the original author.*
