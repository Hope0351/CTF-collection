...
> **Original Source:** [Hack the Box — Blackfield](https://infosecwriteups.com/hack-the-box-blackfield-35b64183a696)
...
I then checked if any of these users are vulnerable to AS-REP Roasting, which I already discussed in my [Forest writeup](https://medium.com/bugbountywriteup/hackthebox-forest-5a11553de1). I used `Impacket’s `GetNPUsers.py:
...
*Originally published on [Medium](https://infosecwriteups.com/hack-the-box-blackfield-35b64183a696). All credit goes to the original author.*
