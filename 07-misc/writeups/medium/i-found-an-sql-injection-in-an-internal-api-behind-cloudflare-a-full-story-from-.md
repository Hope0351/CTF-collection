...
> **Original Source:** [I Found an SQL Injection in an Internal API (Behind Cloudflare) — A Full Story from Discovery to Data Dump](https://infosecwriteups.com/i-found-an-sql-injection-in-an-internal-api-behind-cloudflare-a-full-story-from-discovery-to-27a28d2beb68)
...
*Originally published on [Medium](https://infosecwriteups.com/i-found-an-sql-injection-in-an-internal-api-behind-cloudflare-a-full-story-from-discovery-to-27a28d2beb68). All credit goes to the original author.*
