# Guide-of-Seccomp-in-CTF | n132

> **Source:** Originally published at https://n132.github.io/2022/07/03/Guide-of-Seccomp-in-CTF.html
...
There are four supported operations: SECCOMP_SET_MODE_STRICT, SECCOMP_SET_MODE_FILTER, SECCOMP_GET_ACTION_AVAIL, and SECCOMP_GET_NOTIF_SIZES.
      ...
      only allow read, write, and exit
      0x0
...
`no_new_privs` is crucial, you can find a more detailed description in the manual page of prctl.


As you see, I wrote a filter and applied it. It’s actually a vulnerability sandbox. Anyways, let’s use seccomp-tools to dump the filter.
...
I list some known syscalls:
      ...
      openat, execveat
      Could be used to replace open/execve


      (p)read(v), (p)write(v)
      Could be used to replace read/write


      process_vm_readv / process_vm_writev
      Modify other process’ mem, which may lead vul in another process


      prlimit64
      Limit the resource of a process, which may lead vul in another process
...
This type of challenge is special and I’ll introduce it in this writeup.


      ![Pwn2Own](images/img_1.svg)
      ![kernelCTF](images/img_2.gif)
      ![TyphoonPWN](images/img_3.png)
      ![DEF CON CTF](images/img_4.jpg)


  UI inspired by Google Project Zero
