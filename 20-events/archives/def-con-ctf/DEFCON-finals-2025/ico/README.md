...
`ico` is a service for manipulating Haiku Vector Image Format (HVIF) files. HVIF is a real image format whose reference implementation is within the Haiku operating system. Using resources like Leah Hanson's awesome [blog post](http://blog.leahhanson.us/post/recursecenter2016/haiku_icons.html) from 2016 outlining how the format works, I built a basic, network-ready version of Haiku's Icon-O-Matic application.
