...
<!-- Please edit the original at eta/blob/master/templates/repository/common/CONTRIBUTING.md -->

# Contribute to Ory defcon-30-ctf<!-- omit in toc -->
...
_Please note_: We take Ory defcon-30-ctf's security and our users' trust very
seriously. If you believe you have found a security issue in Ory defcon-30-ctf,
...
defcon-30-ctf's direction. A great way to
do this is via
[Ory defcon-30-ctf Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.com/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](../../../../20-events/archives/def-con-ctf/defcon-30-ctf)

- I have a question. Where can I get
  [answers to questions regarding Ory defcon-30-ctf?](#communication)
...
- I want to talk to other Ory defcon-30-ctf users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  defcon-30-ctf.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/defcon-30-ctf)

- I would like updates about new versions of Ory defcon-30-ctf.
...
[list of good first issues](../../../../20-events/archives/def-con-ctf/defcon-30-ctf).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory defcon-30-ctf.
...
- **Help with open issues.** We have a lot of open issues for Ory defcon-30-ctf and
...
Check out [Ory defcon-30-ctf Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory defcon-30-ctf,
...
before getting started to ensure your work is consistent with Ory defcon-30-ctf's
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](../../../../20-events/archives/def-con-ctf/defcon-30-ctf)
...
[Contributor License Agreement](https://cla-assistant.io/ory/defcon-30-ctf).
...
Ory documentation repository. For further
...
git clone git@github.com:ory/ory/defcon-30-ctf.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/defcon-30-ctf.git
