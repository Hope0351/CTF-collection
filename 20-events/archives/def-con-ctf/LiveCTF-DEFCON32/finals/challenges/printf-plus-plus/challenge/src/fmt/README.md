...
![image](https://github.com/fmtlib/fmt/actions?query=workflow%3Alinux)
![image](https://github.com/fmtlib/fmt/actions?query=workflow%3Amacos)
![image](https://github.com/fmtlib/fmt/actions?query=workflow%3Awindows)
...
Makefiles with CMake:
    ...
    $ git clone --recursive ormat-benchmark.git
    $ cd format-benchmark
    $ cmake .
