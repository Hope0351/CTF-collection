...
- Writing your cimage by hand will be very error-prone.
  ...
  Your script should somewhat archive the parser library, with a function to generate the cimage header and functions for every directive that you want to support.
