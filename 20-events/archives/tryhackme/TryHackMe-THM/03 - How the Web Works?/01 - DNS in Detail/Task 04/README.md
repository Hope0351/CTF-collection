...
Depending on the record type, the DNS record is then sent back to the **Recursive DNS Server**, where a archived copy will be cached for future requests and then relayed back to the original client that made the request. 
