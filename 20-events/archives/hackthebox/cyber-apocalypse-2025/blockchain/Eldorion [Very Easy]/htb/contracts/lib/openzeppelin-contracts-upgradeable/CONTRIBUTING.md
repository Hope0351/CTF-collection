...
[security policy]: penzeppelin-contracts/security
[open an issue]: penzeppelin-contracts/issues/new/choose
...
Changelog entries should be added to each pull request by using Changesets.
