...
- libfcgi overwrites all the important I/O functions that we use for leaks like `printf` and they all have to obey the FastCGI protocol when talking to the web server. source   
    ```c
