...
There are `33` commits in the repository. We can run a tool like trufflehog to scan the repository for potential keys or credentials. 
...
We can use tools like enumerate-iam to identify permissions that these credentials has access to. 
