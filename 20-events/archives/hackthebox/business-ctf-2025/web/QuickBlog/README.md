...
<img src="riteup-templates/raw/master/challenge/assets/images/htb.png" style="margin-left: 20px; zoom: 80%;" align=left />        <font size="10">QuickBlog</font>
...
We could also try to fuzz for markdown speciffic XSS payloads, here i tried the ones from arkdown-XSS-Payloads, but as we can see again they all seem to get sanitized fufficiently.
...
herrypy/blob/main/cherrypy/lib/sessions.py
