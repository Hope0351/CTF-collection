...
So, we will use `pyinstxtractor` to get the `pyc` files out of it and then use [`uncompyle6`](https://pypi.org/project/uncompyle6/), [`decompyle3`](https://pypi.org/project/decompyle3/) or `pycdc` to decompile the game script.
