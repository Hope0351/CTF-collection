...
| Gobuster | Directory/DNS/vhost brute-forcing | [GitHub](../../../../40-tooling/archives/web-tools/gobuster) |
| Feroxbuster | Recursive content discovery | GitHub |
| ffuf | Fast web fuzzer | [GitHub](../../../../40-tooling/archives/web-tools/ffuf) |
...
| Nuclei | Template-based vuln scanner | [GitHub](../../../../40-tooling/archives/web-tools/nuclei) |
...
| Tool | Purpose | Link |
|------|---------|------|
| LinPEAS | Linux privesc enumeration | GitHub |
| WinPEAS | Windows privesc enumeration | GitHub |
| pspy | Process monitoring (no root) | GitHub |
| PowerUp | Windows privesc PowerShell | GitHub |
...
| Tool | Purpose | Link |
|------|---------|------|
| Volatility 3 | Memory forensics | GitHub |
...
| CyberChef | Data transformation | GitHub |
| Chainsaw | Windows event log analysis | GitHub |
...
| Tool | Purpose | Link |
|------|---------|------|
| pwntools | CTF exploit framework | [GitHub](../../../../40-tooling/archives/pwn-tools/pwntools) |
| ROPgadget | ROP chain builder | [GitHub](../../../../40-tooling/archives/pwn-tools/ROPgadget) |
| GEF | GDB enhanced features | [GitHub](../../../../40-tooling/archives/pwn-tools/gef) |
| one_gadget | libc one-shot gadget | GitHub |
| checksec | Binary security checks | [GitHub](../../../../40-tooling/archives/pwn-tools/checksec.sh) |
...
<p align="center">
  ...
  <br><br>
  <a href="tb-writeups/stargazers"><img src="https://img.shields.io/github/stars/momenbasel/htb-writeups?style=social" alt="Star this repo"></a>
</p>
