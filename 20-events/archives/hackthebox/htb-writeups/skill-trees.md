...
<sub>Skill trees are living documents. As new machines release and techniques evolve, these paths will be updated. Suggestions welcome via [GitHub Issues](../../../../20-events/archives/hackthebox/htb-writeups).</sub>
