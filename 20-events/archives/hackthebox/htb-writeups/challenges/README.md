...
| 13 | Infinite Descent | Easy | RSA, Continued Fractions | GitHub |
...
| 6 | SAW | Easy | Android Smali Patching | Hackplayers |
...
| # | Challenge | Difficulty | Key Techniques | Writeup |
|---|-----------|-----------|----------------|---------|
| 1 | Forest | Easy | Image Steg, Steghide, Brightness | z00mik GitHub |
| 2 | Digital Cube | Easy | Image Analysis, Pixel Manipulation | z00mik GitHub |
| 3 | Retro | Easy | Retro Image Steg | z00mik GitHub |
| 4 | Pusheen Loves Graphs | Easy | Graph-Based Steganography | z00mik GitHub |
| 5 | Hackerman | Easy | Steghide, rockyou Wordlist | [Art0fHack](https://art0fhack.blogspot.com/2018/08/stego-hackerman-htb.html) |
| 6 | Widescreen | Easy | Steg Solver | Hackplayers |
...
| 8 | Unprintable | Medium | Non-Printable Characters | z00mik GitHub |
| 9 | Not Art | Medium | Art-Based Steganography | z00mik GitHub |
...
| 11 | Massacre | Hard | Complex Multi-Layer Steg | z00mik GitHub |
| 12 | Senseless Behaviour | Hard | Behavioral Analysis Steg | z00mik GitHub |
...
| 6 | Distract and Destroy | Easy | Smart Contract Logic Exploit | GitHub - KanakSasak |
...
| 8 | Honor Among Thieves | Medium | Multi-Contract Exploitation | GitHub - KanakSasak |
...
| Hackplayers | GitHub | Web, Crypto, Forensics, Mobile, Stego, OSINT |
| Rishitsaiya | GitHub | Crypto, Web, OSINT, Forensics, Reversing |
| z00mik | GitHub | 8 Stego challenges |
| KanakSasak | GitHub | Blockchain challenges |
...
| Esther7171 | GitHub | Multi-category writeups |
