...
|------|-------|-------------|
| parrot-build | 234 | Ansible playbooks to build IppSec's Parrot OS pentesting VM |
| forward-shell | 166 | Forward shell for firewall evasion via mkfifo named pipes |
| ippsec.rocks | 153 | Searchable index of all IppSec YouTube videos |
| PowerSiem | 126 | PowerShell SIEM for analyzing Sysmon events |
| evil-cups | 43 | CUPS exploitation tool (CVE-2024-47076 chain) |
| ctf-scripts | 21 | Scripts created during CTF competitions |
| Jarmis | 8 | JARM TLS fingerprint analysis |
...
#### Bastard [Windows]
- Sherlock was fixed, should no longer report the false negative herlock/commit/ceb49f5b54be54effbada47fa3198abf744af390
...
- archive FTP + Pillage for information, Find keypass in Tim's directory and crack it.
...
- Using wget to archive the website, then a find command with exec to run exiftool and extract all user names in metadata
...
- Download Chainsaw: hainsaw00:00 - Introduction, going over the scenario talking about dumping NTDS and why its incr
