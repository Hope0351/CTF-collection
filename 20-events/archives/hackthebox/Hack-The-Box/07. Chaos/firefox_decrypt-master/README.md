...
If you must use Python 2, please try version 0.7.0.  

If you have problems using it give the latest release a try or check open issues for ongoing work.
...
If you get the error described in #14 when loading `libnss3` consider installing `nss` using brew or other package managers.
