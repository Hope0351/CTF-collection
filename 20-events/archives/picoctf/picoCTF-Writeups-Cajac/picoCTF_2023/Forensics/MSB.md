...
The first tool tried was [zsteg](../../../../../../40-tooling/archives/forensics-tools/zsteg) but that didn't yield anaything.  
...
Alternatively, we can use the stegsolve tool.
...
Finally, you can use the sigBits script to extract the data.
...
- [zsteg - Github](../../../../../../40-tooling/archives/forensics-tools/zsteg)
