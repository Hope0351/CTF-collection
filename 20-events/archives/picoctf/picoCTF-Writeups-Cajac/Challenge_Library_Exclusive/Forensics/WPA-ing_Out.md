...
For cracking I used [aircrack-ng](https://aircrack-ng.org/) together with the rockyou wordlist. The wordlist is included in the Leaked-Databases section of Daniel Miessler's SecLists if you don't have it already.
