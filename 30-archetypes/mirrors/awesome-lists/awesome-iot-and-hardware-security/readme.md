...
Thanks to all [contributors](https://github.com/kayranfatih/awesome-iot-and-hardware-security). The goal is to build community-driven collection of  well-known resources.
...
- [JTAGulator](https://github.com/grandideastudio/jtagulator) - An open-source hardware tool that helps identify JTAG and UART interfaces on unknown targets
...
- [GreatFET](https://github.com/greatscottgadgets/greatfet) - An open-source hardware hacking tool for interfacing with and instrumenting embedded devices over USB
...
- [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
- [KillerBee](https://github.com/riverloopsec/killerbee) - Framework and tools for sniffing, injecting, and auditing Zigbee and IEEE 802.15.4 networks
...
- [ChipSHOUTER-PicoEMP Kit](https://github.com/newaetech/chipshouter-picoemp) - A lower-cost PicoEMP build for self-study and hobbyist EMFI research from the NewAE ecosystem
...
- [FirmWire](https://github.com/FirmWire/FirmWire) - A full-system baseband firmware emulation platform for dynamic analysis of embedded and mobile firmware
- [FIRMADYNE](https://github.com/firmadyne/firmadyne) - An automated system for performing emulation and dynamic analysis of Linux-based embedded firmware
- [FirmAE](https://github.com/pr0v3rbs/FirmAE) - A scalable firmware emulation framework that improves analysis coverage for Linux-based IoT firmware
- [HAL - The Hardware Analyzer](https://github.com/emsec/hal) - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
- [CHIPSEC](https://github.com/chipsec/chipsec) - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
...
- [IoTGoat](https://github.com/OWASP/IoTGoat) - A deliberately insecure OpenWrt-based firmware for learning and practicing IoT security testing
- [DVRF: Damn Vulnerable Router Firmware](https://github.com/praetorian-inc/DVRF) - A vulnerable router firmware image built for hands-on embedded web and firmware exploitation practice
- [EMUX](https://github.com/therealsaumil/emux) - An embedded device emulation framework that is useful for building reproducible firmware-analysis labs
...
- [RHme-2017/2018](https://github.com/Riscure/Rhme-2017) - Riscure Hack Me 3 hardware CTF challenge
...
- [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) - A curated list of IoT and connected-things security resources
