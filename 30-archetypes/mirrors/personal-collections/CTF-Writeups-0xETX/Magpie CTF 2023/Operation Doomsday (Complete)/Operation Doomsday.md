...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/1.png "Prompt")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/2.png "Twitter Search Results")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/3.png "Looking at Trenton's Twitter profile")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/4.png "Analyzing Trenton's tweet")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/5.png "Selecting view hidden replies")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/6.png "Andre saves the day!")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/7.png "Finding the GitHub repo")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/8.png "The griefed GitHub page")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/9.png "A hint to the next steps.")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/10.png "Instagram accounts discovered")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/11.png "Finding Trenton")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/12.png "Trenton's followers")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/13.png "Discovering Trenton's favourite food")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/14.png "Finding out Trenton's cat's name")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/15.png "Discovering Trenton's age")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/16.png "Checking out lazerblackwell.")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/17.png "Catheryn Olson")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/18.png "The mysterious place")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/19.png "Trenton's new friend")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/20.png "Messi is better btw")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/21.png "Entering the blog")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/22.png "The end of the first challenge")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/18.png "Reviewing the old post from earlier")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/23.png "Discovering the location of the event.")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/24.png "Discovering Federici")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/25.png "An interesting discovery")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/26.png "Google Street View")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/27.png "Backtracking our steps")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/28.png "Finding out about the play")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/29.png "Searching for screenings")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/30.png "Finding a special date")
...
![alt-text](https://github.com/0xETX/CTF-Writeups)/Images/31.png "Entering the QR Code")
