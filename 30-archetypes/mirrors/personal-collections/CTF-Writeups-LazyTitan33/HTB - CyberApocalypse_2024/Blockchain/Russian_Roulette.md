...
```
I was first introduced to Blockchain CTF challenges in last year's CyberApocalypse where they provided a tutorial with [Navigating the Unknown](https://github.com/LazyTitan33/CTF-Writeups) and a nice similar challenge with [Shooting101](https://github.com/LazyTitan33/CTF-Writeups). I reused some of the code from there and applied the same principles.
