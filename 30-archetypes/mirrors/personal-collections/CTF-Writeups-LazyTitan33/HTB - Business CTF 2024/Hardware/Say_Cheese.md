...
with open('output_file.bin', 'wb') as f:
    f.write(bytes_data)
```
This was very similar with the [Rids](https://github.com/LazyTitan33/CTF-Writeups) challenge from HTB CyberApocalypse 2024. After a bit of waiting it would seem we downloaded a firmware image:  
