...
[Source website and devme.html here](https://github.com/nh4ttruong/ctf-write-up)
...
Source buyme.tar.xz [chall folder](https://github.com/nh4ttruong/ctf-write-up)
...
The challenge has two source code: [enc.py](https://github.com/nh4ttruong/ctf-write-up) and [flag.enc](cor-ctf-2021/fibinary/flag.enc)

### Solution

The source code [enc.py](https://github.com/nh4ttruong/ctf-write-up):
```python
fib = [1, 1]
for i in range(2, 11):
