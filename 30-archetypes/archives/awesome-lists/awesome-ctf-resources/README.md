...
*Frameworks that can be used to host a CTF*
 ...
 - rCTF - CTF platform created by the redpwn CTF team. Now maintained and developed by [OtterSec](https://osec.io/) team.
...
*Tools used for solving Crypto challenges*
 ...
 - [RsaCtfTool](../../../../40-tooling/archives/crypto-tools/RsaCtfTool) - RSA multi attacks tool.
...
*Tools used for solving Pwn challenges*
 ...
 - [ROPgadget](../../../../40-tooling/archives/pwn-tools/ROPgadget) - Framework for ROP exploitation.
 - [Ropper](../../../../40-tooling/archives/pwn-tools/Ropper) - Display information about files in different file formats and find gadgets to build rop chains for different architectures.
...
A lightweight, online service for when you don’t have the time, resources, or requirements to use a heavier-weight alternative.
 ...
 - [GEF](../../../../40-tooling/archives/pwn-tools/gef) - A modern experience for GDB with advanced debugging features for exploit developers & reverse engineers.
 ...
 - [Jadx](../../../../40-tooling/archives/mobile-tools/jadx) - Command line and GUI tools for producing Java source code from Android Dex and Apk files.
 ...
 - [Pwndbg](../../../../40-tooling/archives/pwn-tools/pwndbg) - Exploit Development and Reverse Engineering with GDB Made Easy.
...
*Tools used for solving Web challenges*
 ...
 - [ffuf](../../../../40-tooling/archives/web-tools/ffuf) - Fast web fuzzer written in Go.
...
*The resources presented here have been gathered from numerous sources. However, the most important are:*
 ...
 - [apsdehal_awesome-ctf](../../../../30-archetypes/archives/awesome-lists/awesome-ctf)
