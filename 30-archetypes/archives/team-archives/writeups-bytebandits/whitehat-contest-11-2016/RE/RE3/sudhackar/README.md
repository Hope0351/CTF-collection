...
This suggests the executable was made using [py2exe](http://www.py2exe.org/). Byte compiled pyc files can be easily fished out from such exe using unpy2exe. We take out the pyc file and then use [Easy Python Decompiler](https://sourceforge.net/projects/easypythondecompiler/) to get
