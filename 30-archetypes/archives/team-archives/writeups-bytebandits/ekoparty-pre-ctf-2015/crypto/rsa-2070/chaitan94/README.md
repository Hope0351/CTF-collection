...
Now that the factors are known, let's generate the private key using rsatool
...
Now we have to just decrypt the [flag](../flag.enc) using the generated private key
