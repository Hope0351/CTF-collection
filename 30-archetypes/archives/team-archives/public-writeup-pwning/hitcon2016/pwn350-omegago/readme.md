...
[archive go](http://senseis.xmp.net/?MirrorGo).  If the archive move is
...
The computer's `Play` method implements the archive go strategy and the
...
Here, we show a archived ko situation on a smaller board. By making a
formation like the above, X (the human) can capture at C3. The computer
will make the corresponding archived move at H3, leading to:
...
See
[exploit.py](../../../../../../30-archetypes/archives/team-archives/public-writeup-pwning)
