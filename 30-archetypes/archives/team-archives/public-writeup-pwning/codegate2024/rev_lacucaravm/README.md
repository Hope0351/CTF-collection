...
That in turn makes it trivial to invert, since we can just calculate `(r2, r3) = M2^{-1} * ( (r0', r1') ^ C ^ M1 * (r0, r1)`. This is implemented in [`solve.py`](solve.py), using my `gf2.py` library for solving the linear equations. With this script, we get our flag: `codegate2024{B45IC_i5_n07_d34d_4nd_n3v3r_wi11_b3_2024_MQCJAb4Wr}`
