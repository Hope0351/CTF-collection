...
After understanding the attack from Gyotaku the Flag, all we had to do is adapt the solver to leak data in this problem.  In particular, our goal was to leak `$_SESSION["secret"]`, which is set in this bit of code:
