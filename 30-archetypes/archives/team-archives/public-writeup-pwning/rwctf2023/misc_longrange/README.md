...
Using GNURadio and the gr-lora plugin (at commit 6111c350c589bee9cc11c0e1d7c3a83fff284843 for compatibility with GNURadio 3.8.5.0), we designed the following decoder:
