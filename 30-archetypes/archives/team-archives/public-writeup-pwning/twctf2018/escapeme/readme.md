...
2. Set up paging. Maps:
   ...
   - 2 MiB of RW direct physical mapping at 0x8040000000. It appears to be
     ...
     physical memory. Looking at the challenge author's code,
...
`scmp_bpf_disasm` from libseccomp):
...
See [exploit.py](../../../../../../30-archetypes/archives/team-archives/public-writeup-pwning) for our full exploit.
