...
That's it! Send the initial payload to bot and make sure your server responds with an appropriate payload. You can see the full exploit script at exploit.ts.