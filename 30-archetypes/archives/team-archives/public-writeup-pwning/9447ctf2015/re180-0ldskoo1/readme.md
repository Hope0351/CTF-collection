...
This challenge is an Xbox iso. You run it via the xqemu xbox emulator, and it plays a 3D animation of the flag. However, most of the flag is obscured by a giant red rectangle that occasionally appears across the screen.
