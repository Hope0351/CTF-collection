...
<img src="ublic-writeup/blob/master/hitcon2015/misc200-phishingme/office_2003.png" width="500">

If using MS Word 2007, click on `View` then `Macros` and thenn finally `View Macros`.
<img src="ublic-writeup/blob/master/hitcon2015/misc200-phishingme/office_2007.png" width="600">
...
<img src="ublic-writeup/blob/master/hitcon2015/misc200-phishingme/macro_dialog.png" width="400">
...
Yay! We are done! It is surprising to note however that `DNS` queries actually allow `{` and `!` characters. The final (cleaned up) macro can be found [here](../../../../../../30-archetypes/archives/team-archives/public-writeup-pwning).
