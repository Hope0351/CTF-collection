...
Extracting the initial state became a matter of copying the relevant section of the game data into a .schematic file using an external editor such as [MC Edit](http://www.mcedit.net), and then extracting the relevant bits of the state using python and NBT to avoid the lengthy process of manually copying the bits out of the game.
