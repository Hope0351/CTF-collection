...
Open the packet (link: TF/blob/master/thekey(Forensics%20100)/thekey.pcapng) by Wireshark. There are somethings interesting:
- The protocol is USB
...
My script can be seen here: TF/blob/master/thekey(Forensics%20100)/get_flag.py
...
[img]:<TF/blob/master/thekey(Forensics%20100)/endpoint_conversaion_statistics.png>
