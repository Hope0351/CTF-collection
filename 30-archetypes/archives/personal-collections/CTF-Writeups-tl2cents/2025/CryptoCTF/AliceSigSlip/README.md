...
``` python
# ycryptodome/blob/2c3a8905a7929335a9b2763e18d6e9ed516b8a38/lib/Crypto/Signature/eddsa.py#L158
...
``` python
# ycryptodome/blob/2c3a8905a7929335a9b2763e18d6e9ed516b8a38/lib/Crypto/Signature/eddsa.py#L244
...
> I find that `PyCryptodome` checks weak points of order 8 on the `Curve25519` in _validate_x25519_point. Why does it not check the weak points of order 8 in `ED25519`?