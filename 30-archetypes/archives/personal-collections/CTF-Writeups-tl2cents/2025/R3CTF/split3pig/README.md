...
This challenge is the third case. Actually I tried cuso to solve this challenge fully automatically, but it failed (always killed or not able to find the roots).
