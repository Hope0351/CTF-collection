...
I sorted all writeups by years and CTF names, so you're welcome to explore them! By the way, I will (at least, I will try to) archive these writeups to VoidHack writeups page, so you can find them here or there.
