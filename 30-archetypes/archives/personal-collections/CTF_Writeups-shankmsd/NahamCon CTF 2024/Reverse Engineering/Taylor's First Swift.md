...
We can see that function names are weird, because swift complier mangles the class, function and variable names. We can demangle this by using SwiftNameDemangler Script.
