...
- John the Ripper
- RsaCtfTool: RSA attack tool (mainly for ctf).
- Wordlists
	- rockyou.txt
	- 10k-most-common.txt
...
### Others
- [pwntool](../../../../40-tooling/archives/pwn-tools/pwntools): CTF framework and exploit development library.
- Pwngdb: Developed by [Angelboy](https://github.com/scwuaptx).
...
- stegsolve: Image stenography solver.
- openstego: Steganography application provides "Data Hiding" & "Watermarking" functionalities.
- TweakPNG: A low-level PNG image file manipulation utility for Windows.
