...
I've been learning quite a bit from Dvd848, who seems really comfortable with the various uses of `pwnlib`. For this problem they use `shellcraft`:
...
0n3m4ns4rmy gets an honorable mention for the shortest shellcode, with no null bytes. They don't say how they generated it -- it may just be from Shellstorm.
