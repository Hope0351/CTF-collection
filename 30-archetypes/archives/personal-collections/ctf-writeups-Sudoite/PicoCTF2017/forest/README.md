...
Robert Meade used decompilers to reproduce the original C code, creates the binary tree in C, and parses it automatically with some Python code.

This write-up also provides the disassembled source code.
