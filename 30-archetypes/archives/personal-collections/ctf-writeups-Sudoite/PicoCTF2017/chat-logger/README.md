...
1. It's really important to visualize the heap for this problem. Try **pwndbg** and **angelheap** (installation instructions in this [write-up](../../../../../../30-archetypes/archives/personal-collections/ctf-writeups-Sudoite)).
...
(Looks like `edit` does not take a `uid`.) Now I go into `gdb` with **pwndbg** and **angelheap** installed [see this write-up](../../../../../../30-archetypes/archives/personal-collections/ctf-writeups-Sudoite), and display the heap:
