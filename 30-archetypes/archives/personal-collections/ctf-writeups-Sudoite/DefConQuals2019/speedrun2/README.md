...
The general theme is the same in the write-ups on CTF Time. guyinatuxedo and wotmd save themselves some time by using One Gadget, so they don't need to pivot to the `.bss` section. I should get used to doing that as well.
