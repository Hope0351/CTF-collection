...
beerpwn actually solved this challenge using ROP, but notes in their write-up that the intended solution is to jump to the shellcode, as ASLR was disabled on the server.
