...
1. [Help Me Reset 2](./PicoCTF2018/web/HelpMeReset2) (PicoCTF 2018): another write-up references the `dirsearch` tool.

### Cryptography

#### RSA

1. P4 blog: what to do when `gcd(e, totient) != 1` for RSA-like problems.
