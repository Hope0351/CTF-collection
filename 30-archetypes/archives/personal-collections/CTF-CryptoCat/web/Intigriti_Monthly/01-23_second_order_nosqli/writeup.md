...
Could improve on the script using a binary search, e.g. [Blind SQLi binary search](../../../../../../../30-archetypes/archives/personal-collections/CTF-CryptoCat) but I cba 😸 Here's an [awesome solution]( https://blog.huli.tw/2023/01/23/en/intigriti-0123-second-order-injection) using a ternary search to achieve the same goal with 185 requests, instead of ~600 🔥
