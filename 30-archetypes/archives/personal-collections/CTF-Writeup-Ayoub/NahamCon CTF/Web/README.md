...
if we look ate the source code provided [here](../fma/) , we see it uses SQLAlchemy 1.2.17 , this version has an issue here it allows an sql injection in **oder by** if not rendered, that's our case, the final exploit in python : 
