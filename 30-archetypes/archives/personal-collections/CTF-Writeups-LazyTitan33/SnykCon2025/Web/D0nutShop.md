...
Doing some research on it on github, using the mention of the d0nut user and the `Math.floor(CONST * Math.random());` line allows me to find this repo: 8_rand_buster
