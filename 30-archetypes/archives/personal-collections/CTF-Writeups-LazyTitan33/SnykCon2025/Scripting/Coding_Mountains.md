...
Eventually I found this csv file which allowed me to be very fast. Using the script below I'm scraping the csv file and searching for the answers. It's not great but running it with pwntools in DEBUG mode, I can see the flag at the end:  
