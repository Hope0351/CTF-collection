...
Using the [RsaCtfTool](../../../../../40-tooling/archives/crypto-tools/RsaCtfTool) we can pass the modulus and the exponent as arguments and try to recover the private key using `--private`.
