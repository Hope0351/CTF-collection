...
This means we can use our good old friend, `RsaCtfTool.py` which you can get from here saCtfTool. We can leave it running and it will eventually spit out the flag.
