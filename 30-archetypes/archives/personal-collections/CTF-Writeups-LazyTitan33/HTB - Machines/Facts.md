...
Armed with the knowledge of the CMS version, we can do some research and find that there is a Privilege Escalation vector when a user changes their password:  
...
>[!NOTE]
>In the meantime, it seems someone reported it and got CVE-2026-1776 assigned which is good that it's tracked and you can update your CMS.
