...
```
I was first introduced to Blockchain CTF challenges in last year's CyberApocalypse where they provided a tutorial with [Navigating the Unknown](../../../../../../30-archetypes/archives/personal-collections/CTF-Writeups-LazyTitan33) and a nice similar challenge with [Shooting101](../../../../../../30-archetypes/archives/personal-collections/CTF-Writeups-LazyTitan33). I reused some of the code from there and applied the same principles.
