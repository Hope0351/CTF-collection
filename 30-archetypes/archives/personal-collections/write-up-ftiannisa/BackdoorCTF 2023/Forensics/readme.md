...
Then I got stuck but one of my teammates suggested to use sstv decoder using Robot36. It's an Android app but since I'm too lazy to grab my phone, I look for an alternative instead and found this repo / tools which do the same job. The installation and usage is pretty easy too, just follow the guide. Use this command to extract an image:
