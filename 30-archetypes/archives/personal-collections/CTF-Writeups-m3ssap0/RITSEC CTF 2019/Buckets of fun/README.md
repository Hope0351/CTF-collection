...
The title of the challenge is a hint to insecure/public AWS S3 buckets, so S3Scanner can be used to easily dump the content.

```
root@m3ss4p0:~# git clone 3Scanner.git
