...
ysoserial `Spring1` payload can be used to have a RCE, but I was not able to find how to exfiltrate the output of commands via pure shell.

So I downloaded ysoserial source code and I patched it in order to have a Java based shell inspired from this one.
...
You can change the code into `ysoserial.payloads.util.Gadgets` class from this...
