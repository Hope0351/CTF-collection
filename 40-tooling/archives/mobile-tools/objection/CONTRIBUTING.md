...
- The Python command line lives [here](../../../../40-tooling/archives/mobile-tools/objection).
- The TypeScript agent lives [here](../../../../40-tooling/archives/mobile-tools/objection).
...
For more information on developing for the agent, please see the Wiki article [here](../../../../40-tooling/archives/mobile-tools/objection).
