...
- `update-binary`: Download the latest [module_installer.sh](../../../../../40-tooling/archives/mobile-tools/Magisk) and rename/copy that script as `update-binary`
...
- When your module is downloaded with the Magisk app, `update-binary` will be **forcefully** replaced with the latest [`module_installer.sh`](../../../../../40-tooling/archives/mobile-tools/Magisk). **DO NOT** try to add any custom logic in `update-binary`.
