...
> Check [Troubleshooting guide](../../../../40-tooling/archives/mobile-tools/jadx) for workarounds.
...
- find usage
- full text search
- smali debugger, check [wiki page](../../../../40-tooling/archives/mobile-tools/jadx) for setup and usage

Jadx-gui key bindings can be found [here](../../../../40-tooling/archives/mobile-tools/jadx)

See these features in action here: [jadx-gui features overview](../../../../40-tooling/archives/mobile-tools/jadx)
...
You can use jadx in your java projects, check details on [wiki page](../../../../40-tooling/archives/mobile-tools/jadx)
...
### Troubleshooting
Please check wiki page [Troubleshooting Q&A](../../../../40-tooling/archives/mobile-tools/jadx)
