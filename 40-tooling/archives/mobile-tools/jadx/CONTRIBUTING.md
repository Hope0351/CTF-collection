...
1. Before proceed, please do:
    - check [Troubleshooting Q&A](../../../../40-tooling/archives/mobile-tools/jadx) section on wiki
...
1. Make sure your code is correctly formatted, see description here: [Code Formatting](../../../../40-tooling/archives/mobile-tools/jadx).
