...
(in the #ethereum channel) to discuss new ideas to improve this tool. You can also take a look at the [`help wanted`](../../../../40-tooling/archives/blockchain-tools/echidna)
issue labels.

## Bug reports and feature suggestions

Bug reports and feature suggestions can be submitted to our [issue
tracker](../../../../40-tooling/archives/blockchain-tools/echidna). For bug reports,
