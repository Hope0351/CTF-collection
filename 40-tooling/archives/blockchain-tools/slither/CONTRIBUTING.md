...
If you're unsure where to start, we recommend our [`good first issue`](../../../../40-tooling/archives/blockchain-tools/slither) and [`help wanted`](../../../../40-tooling/archives/blockchain-tools/slither) issue labels.
...
Instructions for installing a development version of Slither can be found in our [wiki](../../../../40-tooling/archives/blockchain-tools/slither).
...
2. Update slither's `pyproject.toml` to point to that branch:
   ```
   "crytic-compile @ git+rytic-compile.git@your-branch"
   ```
