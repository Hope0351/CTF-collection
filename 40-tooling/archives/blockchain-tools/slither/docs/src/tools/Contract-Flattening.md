...
`slither-flat` can transform the codebase to help some usage (eg. [Echidna](../../../../../../../40-tooling/archives/blockchain-tools/echidna))

- `--convert-external`: convert `external` function to `public`. This is meant to facilitate [Echidna](../../../../../../../40-tooling/archives/blockchain-tools/echidna) usage.
