`slither-prop` generates code properties (e.g., invariants) that can be tested with unit tests or [Echidna](../../../../../../../40-tooling/archives/blockchain-tools/echidna), entirely automatically. Once you have these properties in hand, use [Crytic](https://crytic.io/) to continuously test them with every commit.
...
For example on [examples/slither-prop](../../../../../../../40-tooling/archives/blockchain-tools/slither).
...
On [examples/slither-prop/contracts](../../../../../../../40-tooling/archives/blockchain-tools/slither), update the constructor as follow:
