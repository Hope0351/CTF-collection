...
Likely, you will use one of the proxy from <os>. Clone the `zos`, and install the dependencies:
...
Note: `contracts/mocks/WithConstructorImplementation.sol` must be removed as it contains a [name clash collision](../../../../../../../40-tooling/archives/blockchain-tools/slither) with `contracts/mocks/Invalid.sol`
