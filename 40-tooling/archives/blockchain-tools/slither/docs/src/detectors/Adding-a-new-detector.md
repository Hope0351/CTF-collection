...
See [CONTRIBUTING.md#development-environment](../../../../../../../40-tooling/archives/blockchain-tools/slither)

## Example

[backdoor.py](../../../../../../../40-tooling/archives/blockchain-tools/slither) will detect any function with `backdoor` in its name.
