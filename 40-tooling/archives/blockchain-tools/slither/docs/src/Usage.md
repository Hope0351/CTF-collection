...
`--list-detectors` lists [available detectors](../../../../../../40-tooling/archives/blockchain-tools/slither).
...
`--list-printers` lists [available printers](../../../../../../40-tooling/archives/blockchain-tools/slither).
...
0: C.destination (test.sol#3) is never initialized. It is used in:
 - f (test.sol#5-7)
Reference: lither/wiki/Vulnerabilities-Description#uninitialized-state-variables
