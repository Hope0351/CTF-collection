...
Download pre-compiled binaries from the [releases page](../../../../40-tooling/archives/web-tools/gobuster).
...
- **SecLists**: ecLists
- **FuzzDB**: uzzdb
- **Seclists DNS**: ecLists/tree/master/Discovery/DNS
...
- `no-fqdn` parameter on dns bruteforce to disable the use of the systems search domains. This should speed up the run if you have configured some search domains. [https://github.com/OJ/gobuster/pull/418](../../../../40-tooling/archives/web-tools/gobuster)
