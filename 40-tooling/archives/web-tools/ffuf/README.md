...
- [Installation](../../../../40-tooling/archives/web-tools/ffuf)
- [Example usage](../../../../40-tooling/archives/web-tools/ffuf)
    - [Content discovery](../../../../40-tooling/archives/web-tools/ffuf)
    - [Vhost discovery](../../../../40-tooling/archives/web-tools/ffuf)
    - [Parameter fuzzing](../../../../40-tooling/archives/web-tools/ffuf)
    - [POST data fuzzing](../../../../40-tooling/archives/web-tools/ffuf)
    - [Using external mutator](../../../../40-tooling/archives/web-tools/ffuf)
    - [Configuration files](../../../../40-tooling/archives/web-tools/ffuf)
- [Help](../../../../40-tooling/archives/web-tools/ffuf)
    - [Interactive mode](../../../../40-tooling/archives/web-tools/ffuf)


## Installation

- [Download](../../../../40-tooling/archives/web-tools/ffuf) a prebuilt binary from [releases page](../../../../40-tooling/archives/web-tools/ffuf), unpack and run!
...
- If you have recent go compiler installed: `go install github.com/ffuf/ffuf/v2@latest` (the same command works for updating)
  ...
  _or_
- `git clone fuf ; cd ffuf ; go get ; go build`
...
available in the ffuf wiki at [https://github.com/ffuf/ffuf/wiki](../../../../40-tooling/archives/web-tools/ffuf)
...
You can also practise your ffuf scans against a live host with different lessons and use cases either locally by using the docker container fufme or against the live hosted version at http://ffuf.me created by Adam Langley [@adamtlangley](https://twitter.com/adamtlangley).  
...
[here](../../../../40-tooling/archives/web-tools/ffuf). 

A more detailed description about configuration file locations can be found in the wiki: 
[https://github.com/ffuf/ffuf/wiki/Configuration](../../../../40-tooling/archives/web-tools/ffuf)
...
EXAMPLE USAGE:
  ...
  More information and examples: fuf
```
...
ffuf is released under MIT license. See [LICENSE](../../../../40-tooling/archives/web-tools/ffuf).
