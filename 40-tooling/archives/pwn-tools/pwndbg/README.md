![repository-open-graph](../../../../40-tooling/archives/pwn-tools/pwndbg)
# pwndbg

[![license](https://img.shields.io/github/license/mashape/apistatus.svg?maxAge=2592000)](https://choosealicense.com/licenses/mit/)
[![Tests](../../../../40-tooling/archives/pwn-tools/pwndbg)](https://github.com/pwndbg/pwndbg/actions/workflows/tests.yml)
...
[gdbinit]: dbinit
[gdbinit2]: dbinit/blob/master/gdbinit
[PEDA]: eda
[peda.py]: eda/blob/master/peda.py
[GEF]: ef
[gef.py]: ef/blob/main/gef.py
[bata24/GEF]: ef
[bata24/gef.py]: ef/blob/dev/gef.py
...
[lldb_tracker]: wndbg/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22LLDB%20Port%22
