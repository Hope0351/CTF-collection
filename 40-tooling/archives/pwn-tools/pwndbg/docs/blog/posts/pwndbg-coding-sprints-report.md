...
This blog post is a report of the two coding sprints for the [Pwndbg project](../../../../../../../40-tooling/archives/pwn-tools/pwndbg) that I organized first on the EuroPython 2022 conference and then, taking inspiration from the previous one, in the Hackerspace Kraków, located in Cracow, Poland.
...
* [reviewed and merged the fs/gs_base fetching improvement PR](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [pinned the project's dependencies](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [updated the unicorn dependency version](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [added a "tip of the day" feature](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [improved the UX of using Pwndbg within a Python virtual environment](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* and also [worked on enhancing the display of arguments when stopping on a call to the printf functions family](../../../../../../../40-tooling/archives/pwn-tools/pwndbg).
...
* [Cleanup some code leftover after dropping Python 2 support](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [Added documentation on how to debug Pwndbg using PyCharm remote debugging](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* Reviewed and merged the PRs that [sets `$base_heap` variable](../../../../../../../40-tooling/archives/pwn-tools/pwndbg) and [a tip for it](../../../../../../../40-tooling/archives/pwn-tools/pwndbg), which may be useful for heap exploitation,
* [Fix the X30 register display on AARCH64 targets](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [Fix `context args` display when PC/IP register pointed to unmapped memory](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [Fixed the `xor` and `memfrob` commands and added tests for them (! :D)](../../../../../../../40-tooling/archives/pwn-tools/pwndbg),
* [Worked on adding a way to dump memory that can be copied right away as C or Python code](../../../../../../../40-tooling/archives/pwn-tools/pwndbg) (this needs to be changed to a command flag),
* Investigated a [potential parsing issue](../../../../../../../40-tooling/archives/pwn-tools/pwndbg), even looking at GDB's command parsing source code, [implemented potential patch](../../../../../../../40-tooling/archives/pwn-tools/pwndbg), which only later turned out to be redundant and the issue to be invalid.
