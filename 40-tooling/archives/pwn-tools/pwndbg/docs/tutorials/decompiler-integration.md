...
We implement integration via decomp2dbg (<3) decompiler plugins. All decompiler-side logic is done via decomp2dbg, and all debugger-side logic is handled by Pwndbg.
