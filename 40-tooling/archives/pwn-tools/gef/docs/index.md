...
* Full Python3 support ([Python2 support was dropped in
  2020.03](../../../../../40-tooling/archives/pwn-tools/gef)) - check out
  `gef-legacy` for a Python2 compatible version, and [the
...
For bugs or feature requests, just go [here](../../../../../40-tooling/archives/pwn-tools/gef) and provide a
...
fresh thanks to [all the contributors](../../../../../40-tooling/archives/pwn-tools/gef).
