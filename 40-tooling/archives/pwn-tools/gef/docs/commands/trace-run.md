...
![trace-run-1](https://raw.githubusercontent.com/hugsy/gef/refs/heads/main/docs/assets/images/trace-run-1.png)

By using the script `ida_color_gdb_trace.py` on the text file generated, it will color the path
taken:

![trace-run-2](https://raw.githubusercontent.com/hugsy/gef/refs/heads/main/docs/assets/images/trace-run-2.png)
