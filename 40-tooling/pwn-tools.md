...
| 2 | [ROPgadget](../40-tooling/mirrors/pwn-tools/ROPgadget) | Python | Finds ROP gadgets in ELF/PE/Mach-O binaries. Can automatically generate ROP chains. |
| 3 | [ropper](../40-tooling/mirrors/pwn-tools/Ropper) | Python | Alternative to ROPgadget. Faster on large binaries; supports semantic gadget search. |
...
| 5 | [gdb-gef](../40-tooling/mirrors/pwn-tools/gef) | Python | GDB Enhanced Features. The dominant GDB frontend for CTF. Provides checksec, heap analysis, telescope, pattern_create/offset, and more. |
| 6 | [pwndbg](../40-tooling/mirrors/pwn-tools/pwndbg) | Python | Alternative GDB frontend. Similar feature set to gef; choice is largely aesthetic. |
| 7 | [checksec](../40-tooling/mirrors/pwn-tools/checksec.sh) | Bash | Checks binary security mitigations: NX, PIE, RELRO, stack canary, FORTIFY. |
...
| 9 | [Pwntools-README](../40-tooling/mirrors/pwn-tools/pwntools) | Python | Pwntools GitHub repository — install via `pip install pwntools`. |
