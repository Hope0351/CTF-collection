...
| 2 | [ROPgadget (local mirror)](../repos/JonathanSalwan/ROPgadget) | Python | Finds ROP gadgets in ELF/PE/Mach-O binaries. Can automatically generate ROP chains. |
| 3 | [ropper (local mirror)](../repos/sashs/Ropper) | Python | Alternative to ROPgadget. Faster on large binaries; supports semantic gadget search. |
...
| 5 | [gdb-gef (local mirror)](../repos/hugsy/gef) | Python | GDB Enhanced Features. The dominant GDB frontend for CTF. Provides checksec, heap analysis, telescope, pattern_create/offset, and more. |
| 6 | [pwndbg (local mirror)](../repos/pwndbg/pwndbg) | Python | Alternative GDB frontend. Similar feature set to gef; choice is largely aesthetic. |
| 7 | [checksec (local mirror)](../repos/slimm609/checksec.sh) | Bash | Checks binary security mitigations: NX, PIE, RELRO, stack canary, FORTIFY. |
...
| 9 | [Pwntools-README (local mirror)](../repos/Gallopsled/pwntools) | Python | Pwntools GitHub repository — install via `pip install pwntools`. |
