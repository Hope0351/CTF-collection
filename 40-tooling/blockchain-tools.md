...
| 3 | [Slither](https://github.com/crytic/slither) | Python | Solidity static analyzer. Detects 90+ vulnerability classes. Essential for source-code review. |
| 4 | [Echidna](https://github.com/crytic/echidna) | Haskell | Solidity fuzzer. Property-based testing of smart contracts. |
| 5 | [Mythril](https://github.com/Consensys/mythril) | Python | Symbolic execution for Ethereum smart contracts. Detects common vulnerability classes. |
