...
| 3 | [Slither (local mirror)](../repos/crytic/slither) | Python | Solidity static analyzer. Detects 90+ vulnerability classes. Essential for source-code review. |
| 4 | [Echidna (local mirror)](../repos/crytic/echidna) | Haskell | Solidity fuzzer. Property-based testing of smart contracts. |
| 5 | [Mythril (local mirror)](../repos/Consensys/mythril) | Python | Symbolic execution for Ethereum smart contracts. Detects common vulnerability classes. |
