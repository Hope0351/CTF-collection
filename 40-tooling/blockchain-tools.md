...
| 3 | [Slither](../40-tooling/mirrors/blockchain-tools/slither) | Python | Solidity static analyzer. Detects 90+ vulnerability classes. Essential for source-code review. |
| 4 | [Echidna](../40-tooling/mirrors/blockchain-tools/echidna) | Haskell | Solidity fuzzer. Property-based testing of smart contracts. |
| 5 | [Mythril](../40-tooling/mirrors/blockchain-tools/mythril) | Python | Symbolic execution for Ethereum smart contracts. Detects common vulnerability classes. |
