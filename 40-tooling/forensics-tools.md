...
| 6 | [binwalk](https://github.com/ReFirmLabs/binwalk) | Python | Firmware analysis. Identifies and extracts embedded files. |
...
| 9 | [zsteg](https://github.com/zed-0xff/zsteg) | Ruby | PNG/BMP stego detector. Detects LSB steganography. |
