...
| 6 | [binwalk](../40-tooling/mirrors/forensics-tools/binwalk) | Python | Firmware analysis. Identifies and extracts embedded files. |
...
| 9 | [zsteg](../40-tooling/mirrors/forensics-tools/zsteg) | Ruby | PNG/BMP stego detector. Detects LSB steganography. |
