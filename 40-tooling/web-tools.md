...
| 3 | [ffuf](../40-tooling/mirrors/web-tools/ffuf) | Go | Fast web fuzzer. Used for directory, vhost, and parameter enumeration. Filters by response size, status, words. |
| 4 | [gobuster](../40-tooling/mirrors/web-tools/gobuster) | Go | Alternative directory buster. Simpler than ffuf; good for quick enumeration. |
| 5 | [nuclei](../40-tooling/mirrors/web-tools/nuclei) | Go | Template-based vulnerability scanner. 5000+ community templates for known CVEs and misconfigurations. |
