...
!!! tip
    ...
    - for Ubuntu 20.04 use the [2024.08.29 release](https://github.com/pwndbg/pwndbg)
    - for Ubuntu 18.04 use the [2023.07.17: ubuntu18.04-final release](https://github.com/pwndbg/pwndbg)
