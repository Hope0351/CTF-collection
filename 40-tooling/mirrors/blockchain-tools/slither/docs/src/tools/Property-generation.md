...
For example on [examples/slither-prop](https://github.com/crytic/slither).
...
On [examples/slither-prop/contracts](https://github.com/crytic/slither), update the constructor as follow:
