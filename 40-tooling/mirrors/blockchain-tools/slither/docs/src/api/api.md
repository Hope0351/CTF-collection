...
A [`SlitherCompilationUnit`](https://github.com/crytic/slither) has:
...
A [`Contract`](https://github.com/crytic/slither) object has:
...
A [`Function`](https://github.com/crytic/slither) or a `Modifier` object has:
...
[Node](https://github.com/crytic/slither)
...
- [slither/slithir](https://github.com/crytic/slither)
