...
See [CONTRIBUTING.md#development-environment](https://github.com/crytic/slither)

## Example

[backdoor.py](https://github.com/crytic/slither) will detect any function with `backdoor` in its name.
