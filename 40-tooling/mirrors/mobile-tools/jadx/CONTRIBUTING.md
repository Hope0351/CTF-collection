...
1. Before proceed, please do:
    - check [Troubleshooting Q&A](https://github.com/skylot/jadx) section on wiki
...
1. Make sure your code is correctly formatted, see description here: [Code Formatting](https://github.com/skylot/jadx).
