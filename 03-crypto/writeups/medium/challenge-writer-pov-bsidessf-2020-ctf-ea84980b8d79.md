...
Yes, the name of the challenge was inspired by Big Bang Theory :) The challenge itself was inspired by [d0nutptr@’](https://twitter.com/d0nutptr)s write-up onexfiltrating hidden form fields using the general and adjacent sibling selectors.
