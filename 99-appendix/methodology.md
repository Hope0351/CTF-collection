...
Each search returned up to 20 results. After extracting GitHub repository URLs with a strict regex filter (excluding blob/tree/issues/pull paths and github.com utility pages like /topics, /trending, /explore), all mentions were normalized to canonical `https://github.com/<owner>/<repo>` form and de-duplicated. Each source was then scored along two axes:
...
|---|---|
| **GitHub Repository** | URL matches `github.com/<owner>/<repo>` |
